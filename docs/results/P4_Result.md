...
| T4-5 L3 조회 폭주 | ⏳(측정중) | **Before 규명 + ①②(독립 A2·누적 C2) 완료**: 3,000TPS 목표에서 포화. 병목=커넥션 점유시간. **① pool: 지렛대 아님**. **② SCARD tx밖: usage 6.9→2.6ms(−63%)·처리량 +62%** — 최대 단일 지렛대. **누적: ②위에 ①얹어도 이득≈0(①②는 상호 대체재)**. 단 여전히 SLO 미달(~2,000/p95 2.3s) → ③④ 진행 |
